...
function Navbar({ cartItems }) {
  ...
  const username = localStorage.getItem("username") || "Guest"; // Removed `setUsername`
      ...
      <div className="profile-button" onClick={handleProfileClick} ref={dropdownRef}>
        ...
        {showProfileDropdown && (
          <div className="profile-dropdown">
            ...
            <div className="profile-content" onClick={handleGetAiHelpClick}>
              Get AI Help
            </div>
            <button className="reset-button" onClick={() => setShowProfileDropdown(false)}>
              Back
            </button>
          </div>
        )}
